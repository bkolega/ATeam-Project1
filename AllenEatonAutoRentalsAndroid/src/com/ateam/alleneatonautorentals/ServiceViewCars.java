...
public class ServiceViewCars extends ListActivity {
	...
	class LoadAllCars extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progressDialog = new ProgressDialog(ServiceViewCars.this);
		...
		protected void onPostExecute(String message) {
			...
			if (message != null) {
				Toast.makeText(ServiceViewCars.this, message, Toast.LENGTH_LONG).show();
			}
			else {
